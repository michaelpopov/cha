...
// A character as defined under characters/. Forum-specific overrides and
// prompt expansion are stored on WorkspaceForumMember.
...
// system/assistant/character.toml has no CHARACTER.md and is therefore kept
// separate from user-defined characters.
...
public:
    ...
    [[nodiscard]] const WorkspaceAssistant& assistant() const noexcept {
        return assistant_;
    }
